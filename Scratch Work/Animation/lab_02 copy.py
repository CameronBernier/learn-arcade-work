...
def door(x, y):
    arcade.draw_ellipse_filled(410 + x, 290 + y, 40, 60, (75, 83, 32))
    arcade.draw_ellipse_outline(410 + x, 290 + y, 40, 60, (0, 66, 37))
    arcade.draw_text("o", 410 + x, 280 + y, (237, 145, 33), font_size=17)
